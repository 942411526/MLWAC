...
-------
SequenceEncoder
    Hybrid Transformer + GRU encoder for sequential waypoint data.
MLWAC
...
class MLWAC(nn.Module):
    ...
    action_pred_net
        Predicts angular actions from the d feature token.

    Args:
        vision_encoder: Pre-built vision encoder module .
    ...
    def forward(self, func_name: str, **kwargs) -> torch.Tensor:
        ...
        if func_name == "vision_encoder":
            ...
            raise NotImplementedError(
                ...
                " 'waypoint_pred_net', 'action_pred_net'."
            )
